...
for imgfile in sorted(os.listdir(directory)):
    if imgfile.endswith('.JPG') or imgfile.endswith('.jpg') or imgfile.endswith('.png') or imgfile.endswith('.PNG'):
        ...
        print("<td><textarea name=\"caption-" + imgfile +"\" cols=\"80\" rows=\"20\">" + caption + "</textarea></td>")
        print("<td><input type=\"radio\" name=\"cover\" value=\"" + imgfile + "\">Set as cover picture<td></tr>")
print("</table></form>")
